...
// Fixed: was AaudioModuleSchema (double 'a') — caused ReferenceError on startup
const AudioModuleSchema = new Schema(
  {
    ...
    replay_limit: { type: Number, default: 3 },
...
AudioModuleSchema.index({ topic_id: 1, sub_topic_id: 1 });
AudioModuleSchema.index({ created_by: 1 });

module.exports = model("AudioModule", AudioModuleSchema);
